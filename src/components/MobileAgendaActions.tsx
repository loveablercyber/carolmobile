  ...
  return (
    <nav aria-label="Atalhos da agenda" className="no-scrollbar mb-4 flex gap-2 overflow-x-auto sm:hidden">
      {items.map((item) => {
        ...
        const className = "mobile-agenda-action flex min-h-[82px] min-w-[92px] flex-1 flex-col items-center justify-center gap-2 rounded-2xl border border-black/[.06] bg-white px-2 text-center text-[10px] font-bold shadow-card";
